<?php include"header.php"?>    
        <div class="fluid-container">
                    <img src="./img/bg-img/About_us_banner.jpg" class="cheque-cashing-cover">
            <div class="cheque-banner-text">
                <h1 style="color:white">Save time.</h1>
                <h6 style="color:white">And a tree.</h6>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="subscribe-text">
                         ...
                         <h5>Cheque Cashing,Cash Money provides quick and affordable cheque cashing services.
<h5>
                    </div>
                </div>
                <!-- Subscribe Form -->
