    ...
    <div class="about-us-area about-page section-padding-40">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <h5>Flexible Repayment Options</h5>Borrow between $1,000 and $15,000 and pay it back with flexible repayment plans up to 60 months.
                    </li>
                   <li>
                <h5>Build Your Credit History, One Payment at a Time</h5>With an installment loan, you could improve your credit rating by making regular on-time payments
                </li>
                <li>
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-content color_h4">
					   ...
					   and we will be happy to walk you through the entire process.
						 ...
						 <ul class="marginul" >
						 <li>Be at least 19 years old
						 </li>
						 <li>Have a bank account
						 </li>
						 <li>A steady source of income
						 </li>
						 <ul>
